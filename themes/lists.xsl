...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="//*[(parent::body or parent::div[contains(@class,'section')]) and (self::ul or self::ol or self::dl or self::*[contains(@class, 'addtolist')])][not(contains(@class, 'nomultiple'))]">
