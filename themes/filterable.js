    ...
    var FilterableDl = function (dl) {
      var
        ...
        createKw = function (dd, kw, kwn) {
          ...
          a.href = "#" + kwn;
          a.setAttribute("dataset-value", kwn);
              ...
              if (tags[kw].length > 1) {
                ...
                tags[kw][i].tag.onclick = function () {
                  var options = {
                    ...
                    'eventAction': 'try inactive',
                    'eventLabel': normalize(this.textContent)
                  };
                  sendGAEvent(options);
                  return false
                };
        ...
        toggleFilterButton = function () {
          var options = {
            ...
            'eventLabel': filterButton.textContent
          };
          sendGAEvent(options);
