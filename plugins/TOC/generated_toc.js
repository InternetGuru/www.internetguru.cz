...
generated_toc = {
  generate: function() {
    ...
    if (generate_for == 'page') {
      ...
      top_node = tocparent.parentNode.parentNode;
    }
    ...
    if (status && status == "closed") {
      ...
      toggle_initially = "zobrazit";
    } else {
      display_initially = "block";
      toggle_initially = "skrýt";
    }
    ...
    s.appendChild(document.createTextNode('Obsah'));
    p.appendChild(s);
    ...
    dd.appendChild(cur_list_el);
    tocparent.appendChild(dd);
  ...
  wrapOpenClose: function(a, cur_list_el) {
    ...
    return function(e) {
      ...
      a.firstChild.nodeValue = (d == 'block' ? 'zobrazit' : 'skrýt');
