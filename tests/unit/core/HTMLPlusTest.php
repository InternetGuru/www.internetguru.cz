...
class HTMLPlusTest extends \PHPUnit_Framework_TestCase {
  ...
  public function testDuplicitId () {
    $this->doc->loadXML(
      '<body xml:lang="en"><h id="a">x</h><desc/>'
  ...
  public function testDuplicitLink () {
    $this->doc->loadXML(
      '<body xml:lang="en"><h author="test" id="a" link="x/x">x</h><desc/>'
  ...
  public function testValidXML () {
    $e = null;
    $this->doc->loadXML(
      '<body xml:lang="en" ns="localhost/b"><h author="test" id="h.abc" link="x" short="x" ctime="2015">xx xx</h><desc kw="kw">desc</desc></body>'
    );
    try {
      $this->doc->validatePlus();
    } catch (Exception $e) {
  ...
  public function testH1InForm () {
    $this->doc->loadXML(
      '<body xml:lang="en"><h id="h.abc">x</h><desc/><form action="." method="post"><div><h1/></div></form></body>'
    );
  ...
  public function testListInPar () {
    $e = null;
    $this->doc->loadXML(
      '<body xml:lang="en"><h id="hx">x</h><desc/><p>a<dl><dt/><dd/></dl>b<ul><li/></ul>c</p></body>'
    );
    try {
      $this->doc->validatePlus();
    } catch (Exception $e) {
  ...
  public function testHLinkInvalidRepair () {
    $this->doc->loadXML(
      '<body xml:lang="en"><h author="test" id="h.abc" link="á bé">x</h><desc kw="a">desc</desc></body>'
    );
    $e = null;
    try {
      $this->doc->validatePlus(true);
  ...
  public function testHLinkInvalidRepairUnable () {
    $this->doc->loadXML(
      '<body xml:lang="en"><h author="test" id="a" link="á bé">x</h><desc/>'
